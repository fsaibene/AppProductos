...
public class UsersRepository implements IUsersRepository {
    ...
    public UsersRepository(ICloudUsersDataSource userService, IUserPreferences userPreferences, Context controllerContext){
    ...
    public void auth(String email, String password, final OnAuthenticateListener callback) {
        ...
        mUserService.auth(email, password, new ICloudUsersDataSource.UserServiceCallback() {
            @Override
